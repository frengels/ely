...
ely_literal
ely_literal_create_int(const char* str, size_t len, const ely_position* pos)
{
    return create_literal(str, len, pos, ELY_LITERAL_INT);
}

ely_literal
ely_literal_create_dec(const char* str, size_t len, const ely_position* pos)
{
    return create_literal(str, len, pos, ELY_LITERAL_DEC);
}

ely_literal
ely_literal_create_string(const char* str, size_t len, const ely_position* pos)
{
    return create_literal(str, len, pos, ELY_LITERAL_STRING);
}

ely_literal
ely_literal_create_char(const char* str, size_t len, const ely_position* pos)
{
    return create_literal(str, len, pos, ELY_LITERAL_CHAR);
}

ely_literal ely_literal_create_bool(bool b, const ely_position* pos)
{
    ely_literal res;
    res.pos    = *pos;
